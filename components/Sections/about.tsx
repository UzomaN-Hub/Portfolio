...
export default function About() {
  return (
    <div id="about" className="w-full px-4 py-6 bg-dark-oil-brown shadow-md dark:border-b dark:border-yellow-500">
      ...
      <div className="flex flex-col md:flex-row mt-6 gap-6 py-8 md:py-24">
        ...
        <div className="w-full md:w-1/2 items-center flex">
          <p className={`${space.className} text-justify text-md text-stone-900 dark:text-amber-50`}>
            ...
            <b>Next.js</b>. Alongside front-end development, I also bring
            experience in building robust back-end solutions with <b>Python</b>{" "}
            and <b>Django</b>. <br />
            <br />
