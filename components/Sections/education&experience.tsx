        ...
        <div className="flex flex-col md:flex-row mt-6 gap-6">
          ...
          <div className="w-full md:w-1/2 px-2"> 
            ...
            <div className="border-l-2 relative border-dotted px-2 border-oil-brown mb-6 md:mb-8">
              ...
              <p className="text-justify text-xl md:text-2xl font-bold text-oil-brown dark:text-amber-50"> 
                Jenga Tech Institute
              </p>
              <p className="text-justify text-lg text-[#412201] dark:text-amber-50">
                Diploma in Software Engineering
              </p>
              <p className="text-justify text-xs text-[#412201] dark:text-amber-50">
                September 2024
              </p>
              <p className="text-justify mt-2 md:mt-4 text-sm md:text-md text-stone-950 dark:text-amber-50"> 
          ...
          <div className="w-full md:w-1/2 px-2 mt-8 md:mt-0">
            ...
            <div className="border-l-2 relative border-dotted px-2 border-oil-brown mb-8">
              ...
              <p className="text-justify mt-4 text-sm md:text-md text-stone-950 dark:text-amber-50"> {/* Adjust font size */}
            ...
            <div className="border-l-2 mt-3 relative border-dotted px-2 border-oil-brown">
              <div className="absolute left-[-5px] -top-1 w-2 h-2 rounded-full bg-oil-brown"></div>
              <p className="text-justify text-xl md:text-2xl font-bold text-oil-brown dark:text-amber-50"> {/* Adjust font size */}
